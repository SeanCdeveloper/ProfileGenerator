                        ...
                        <div id="userDiv" class="card wrapper">
                            <div class="card-body">
                                ...
                                <div id="infoRow" class="row">
                                    ...
                                    <h1 id="workExp" class="photo-header workExp-date"></h1>
                                    <ul class="nav links-nav justify-content-center">
                                        <li class="nav-link">
                                        <a class="nav-link active" href="#"><i class="fas fa-location-arrow"></i></span>&nbsp;${data.location}</a>
                                        </li>
                                        <li class="nav-link">
                                        <a class="nav-link active" href="github.com/${data.username}"><i class="fab fa-github-alt"></i>&nbsp;Github</a>
                                        </li>
                                        <li class="nav-link">
